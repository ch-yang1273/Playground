...
function convertCase(text: string, targetCase: 'upper' | 'lower'): string {
    if (targetCase === 'upper') {
        ...
        tools: [
            {
                name: "convert_case",
                description:
                    "Convert the case of a string to uppercase or lowercase. " +
                    "Takes a text string and the target case ('upper' or 'lower') as input. " +
                    "Returns the converted string.",
                inputSchema: zodToJsonSchema(ConvertCaseArgsSchema) as ToolInput,
            },
        ],
    };
});
